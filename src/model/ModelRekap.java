...
public class ModelRekap {
    ...
    public ModelRekap(String idKonfirmasi, String dpCicilan, String sisa, String status, String total, String lamaCicilan, String harga, String idPembelian) {
        this.idKonfirmasi = idKonfirmasi;
        this.dpCicilan = dpCicilan;
        this.sisa = sisa;
        this.status = status;
    ...
    public Object[] toRowTable(HistoriRekapEventAction event) {
        return new Object[]{
